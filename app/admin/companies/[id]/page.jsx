...
const CompanySetup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`/api/company/updatecompany/${id}`, formData, {
                ...
                <form onSubmit={submitHandler}>
                    <div className='flex items-center gap-5 p-8'>
                        <Button
                            ...
                            onClick={() => router.push("/admin/companies")} variant="outline"
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <Input type="text" name="website"
                                value={input.website} onChange={changeEventHandler}
                            />
                        </div>
                        <div>
